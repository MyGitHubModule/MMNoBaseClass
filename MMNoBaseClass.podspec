...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MMNoBaseClass.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/anotherchase@gmail.com/MMNoBaseClass'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'anotherchase@gmail.com' => 'AnotherChase@gmail.com' }
  s.source           = { :git => 'https://github.com/anotherchase@gmail.com/MMNoBaseClass.git', :tag => s.version.to_s }
